...
@DiscriminatorColumn(name = PersonJoined.TYPEPERSON)
public class PersonJoined extends BaseEntity{
	...
	public PersonJoined(final String name, final Date birstDate) {
		super();
		this.name = name;
